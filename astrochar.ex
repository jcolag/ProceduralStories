...
defmodule Orrery do
  defp init() do
    ...
    p5 = %Planet{id: 4, name: "Moon", mass: 73, centerid: 1, focusangle: 0, focusdist: 0, aradius: 385, eccentricity: 0.0549, traitid: 1, effectid: 3, eventid: -1, metalid: 1, positive: true, currangle: 0}
