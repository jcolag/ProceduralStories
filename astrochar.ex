...
defmodule Orrery do
  defstruct planets: [], elements: [], qualities: [], qualities: [], traits: [], effects: [], events: [], metals: [], constellations: [], aspects: []
  ...
  defp init() do
    ...
    as1 = %Aspect{id: 1, name: "Conjunction", angle: 0, delta: 8, influence: 5}
    as2 = %Aspect{id: 2, name: "Opposition", angle: 180, delta: 8, influence: -5}
    as3 = %Aspect{id: 3, name: "Trine", angle: 120, delta: 8, influence: 4}
    as4 = %Aspect{id: 4, name: "Square", angle: 90, delta: 8, influence: -4}
    as5 = %Aspect{id: 5, name: "Sextile", angle: 60, delta: 6, influence: 3}
    as6 = %Aspect{id: 6, name: "Quincunx", angle: 150, delta: 3, influence: -3}
    as7 = %Aspect{id: 7, name: "Semisextile", angle: 30, delta: 2, influence: 2}
    as8 = %Aspect{id: 8, name: "Semisquare", angle: 45, delta: 2, influence: -2}
    as9 = %Aspect{id: 9, name: "Sesquiquadrate", angle: 135, delta: 2, influence: -1}
    as10 = %Aspect{id: 10, name: "Quintile", angle: 72, delta: 2, influence: 1}
    as11 = %Aspect{id: 11, name: "Biquintile", angle: 144, delta: 2, influence: 1}
    aspects = [as1, as2, as3, as4, as5, as6, as7, as8, as9, as10, as11]
    
    %Orrery {planets: planets, elements: elements, qualities: qualities, traits: traits, effects: effects, events: events, metals: metals, constellations: constellations, aspects: aspects}
  end
